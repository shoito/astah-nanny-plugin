package com.github.astah.nanny.updater;
...
import com.github.astah.nanny.updater.NotificationPopup.Position;


public class AutoUpdater {
	private static final Logger logger = LoggerFactory.getLogger(AutoUpdater.class);
	private String updateXml = "https://raw.github.com/shoito/astah-nanny-plugin/master/update.xml";
